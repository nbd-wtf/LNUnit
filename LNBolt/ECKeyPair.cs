...
internal class ECKeyPair : IComparable<ECKeyPair>
{
    ...
    public static readonly ECDomainParameters DomainParameter =
    ...
    public byte[] PublicKeyCompressed
    {
        get
        {
            var ecPoint = PublicKeyParameters.Q.Normalize();
    ...
    public ECPublicKeyParameters PublicKeyParameters
    {
        get
        {
            if (_key is ECPublicKeyParameters) return (ECPublicKeyParameters)_key;
    ...
    public int CompareTo(ECKeyPair other)
    {
        ...
        var publicKeyCompare = !other.HasPrivateKey || !HasPrivateKey;
